...
`, template.innerHTML.trim());
  ...
  function isEditableElement(element) {
    return element.matches && element.matches("input, textarea, [contenteditable]");
  }
  ...
  // js/hooks/index.js
  var hooks_default2 = { Keyboard: keyboard_default };
  ...
  window.addEventListener(
    ...
    (info) => import_topbar.default.delayedShow(200)
  );
